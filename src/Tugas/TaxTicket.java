...
public class TaxTicket extends Ticket implements Operational {
    ...
    public TaxTicket(TicketInfo ticketInfo) {
    ...
    public void displayEstimatedDuration(){
        System.out.println("Estimated travel durationL: " + duration + " minutes");
    }
    ...
    public void sLowDown(double speedReduction){
        ...
        System.out.println("Taxi slowed down: " + speed + " km/h");
    }
